...
local ChangeHistoryService = Services["ChangeHistoryService"]
    ...
    local IsMobile = not UserInputService.KeyboardEnabled and true or false
    ...
    local Games = {
        ...
        [8443571594] = "FruitForager",
        [6676839751] = "Rorvik",
        [7541395924] = "BuildAnIsland",
        -- [] = "Dig",
        [5750914919] = "Fisch"
    }
    ...
    Library = {
        ...
        MenuKeybind = tostring(Enum.KeyCode.P), 
        Flags = { },
    ...
    local Instances = { } do
        ...
        Instances.Connect = function(self, Event, Callback, Name)
            ...
            if Event == "Activated" or Event == "MouseButton1Click" then 
                if IsMobile then 
                    Event = "TouchTap"
                end
    ...
    local Components = { } do
        ...
        Components.Dropdown = function(Data)
            ...
            Items["RealDropdown"]:Connect("Activated", function()
        ...
        Components.Colorpicker = function(Data)
            ...
            local Items = { } do
                ...
                DropdownItems["RealDropdown"]:Connect("Activated", function()
                    Dropdown:SetOpen(not Dropdown.IsOpen)
                end)
            ...
            local Items = { } do
                ...
                function Dropdown:SetOpen(Bool)
                    ...
                    if Bool then 
                        ...
                        RenderStepped = RunService.RenderStepped:Connect(function()
                            DropdownItems["OptionHolder"].Instance.Position = UDim2New(0, DropdownItems["RealDropdown"].Instance.AbsolutePosition.X, 0,  DropdownItems["RealDropdown"].Instance.AbsolutePosition.Y + DropdownItems["RealDropdown"].Instance.AbsoluteSize.Y + 35)
                            DropdownItems["OptionHolder"].Instance.Size = UDim2New(0, DropdownItems["RealDropdown"].Instance.AbsoluteSize.X, 0, 85)
                        end)
                    else
                        if RenderStepped then
                ...
                ToggleItems["Toggle"]:Connect("Activated", function()
                    Toggle:Set(not Toggle.Value)
                end)
    ...
    do -- Element functions
        Library.ESPPreview = function(self, Data)
            ...
            Items["CloseButton"]:Connect("Activated", function()
        ...
        Library.ChatSystem = function(self, Data)
            ...
            Items["SendMessageButton"]:Connect("Activated", function()
        ...
        Library.Window = function(self, Data)
            ...
            Items["MinimizeButton"]:Connect("Activated", function()
        ...
        Library.Page = function(self, Data)
            ...
            Items["Inactive"]:Connect("Activated", function()
        ...
        Library.Pages.Playerlist = function(self, Data)
            ...
            function Playerlist:Add(Player)
                ...
                PlayerItems["NewPlayer"]:Connect("Activated", function()
                    PlayerData:Set()
                end)
        ...
        Library.Sections.Button = function(self, Data)
            ...
            Items["Button"]:Connect("Activated", function()
                Button:Press()
            end)
